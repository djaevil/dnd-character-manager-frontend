...
function GuestLayout({ children }: GuestLayoutProps) {
  return (
    <>
      <div className="d-flex flex-column justify-content-between vh-100 vw-100 overflow-hidden page-bg">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="w-100 rounded-3 bg-dark p-3 shadow-lg maxW500">
            {children}
          </div>
        </div>
